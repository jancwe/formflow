...
class PdfGenerator:
    ...
    def generate(
        ...
        resolved_fields = self._resolve_signature_labels(form_def.get("fields", []), form_data, date_today_str)
    ...
    def _resolve_signature_labels(
        ...
        for field in fields:
            if field.get("type") == "signature" and field.get("signature_label"):
                field = dict(field)
                field["signature_label_resolved"] = _resolve_signature_label(field["signature_label"], form_data, date_today)

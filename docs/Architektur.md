...
| `APP_COMPANY__LOGO_FILENAME` | String | Logo-Dateiname in `/app/static/` (Standard-Logo im Image enthalten; eigenes Logo per Volume-Mount oder Custom-Dockerfile einbinden, siehe README) |

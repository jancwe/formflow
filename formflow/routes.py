...
def register_routes(app: Flask, engine) -> None:
    """Registriert die Flask-Routen für die FormEngine."""
    ...
    @app.route('/confirm/<form_id>/<file_id>', methods=['POST'])
    ...
    @app.route('/edit/<form_id>/<file_id>', methods=['POST'])
    ...
    @app.route('/draft/<form_id>', methods=['POST'])
    ...
    @app.route('/draft/<form_id>/<draft_id>/load', methods=['GET'])
